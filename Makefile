...
SRC=src/main.c \
	...
	src/parser/file_parse.c src/parser/parse_elements.c src/parser/parse_shapes.c src/parser/validators.c src/parser/validators2.c src/parser/default_values.c \
